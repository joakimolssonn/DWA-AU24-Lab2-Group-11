...
namespace DWA_AU24_Lab2_Group_11.Migrations
{
    ...
    [Migration("20241129101856_PlantingScheduleModified")]
    partial class PlantingScheduleModified
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DWA_AU24_Lab2_Group_11.Models.HarvestTracking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            HarvestDate = new DateTime(2024, 12, 9, 11, 18, 55, 236, DateTimeKind.Local).AddTicks(7048),
                            PlantingScheduleId = 1
                        },
                        new
                        {
                            Id = 2,
                            HarvestDate = new DateTime(2024, 12, 9, 11, 18, 55, 236, DateTimeKind.Local).AddTicks(7053),
            ...
            modelBuilder.Entity("DWA_AU24_Lab2_Group_11.Models.PlantingSchedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Cropid = 1,
                            Location = "Field A",
                            PlantingDate = new DateTime(2024, 10, 30, 11, 18, 55, 236, DateTimeKind.Local).AddTicks(6965)
                        },
                        new
                        {
                            Id = 2,
                            Cropid = 2,
                            Location = "Greenhouse",
                            PlantingDate = new DateTime(2024, 9, 30, 11, 18, 55, 236, DateTimeKind.Local).AddTicks(7023)
                        });
                });
