...
namespace DWA_AU24_Lab2_Group_11.Services
{
    public class WeatherApiService
    {
        ...
        public async Task<WeatherData> FetchWeatherAsync(double latitude, double longitude)
        {
            ...
            var weatherApiResponse = JsonConvert.DeserializeObject<Root>(json);
            ...
            return new WeatherData
            {
                ...
                Location = weatherApiResponse.name,
                Icon = weatherApiResponse.weather[0].icon // Fetch weather icon
            };
        }
